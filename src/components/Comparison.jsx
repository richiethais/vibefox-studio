          ...
          <div className="fade-up d3" style={{ marginTop: 52, borderRadius: 16, border: '1px solid rgba(255,255,255,0.07)', overflow: 'hidden' }}>
            <div>
              ...
              {rows.map(row => (
                ...
                >
                  <div style={{ ...tdStyle, color: 'rgba(255,255,255,0.62)', fontWeight: 500 }}>{row.feature}</div>
                  <div style={{ ...tdStyle, color: 'rgba(255,255,255,0.28)' }}>{row.agency}</div>
                  <div style={{ ...tdStyle, background: 'rgba(200,169,126,0.06)', color: row.usStrong ? 'rgba(255,255,255,0.72)' : 'rgba(255,255,255,0.37)' }}>
