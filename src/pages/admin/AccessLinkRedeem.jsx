...
export default function AdminAccessLinkRedeem() {
  ...
  useEffect(() => {
    ...
    // Always persist to localStorage so session stays until explicit logout
      ...
      <div style={{
        ...
        <div style={{ marginTop: 18, fontSize: 12, color: '#6b7280', lineHeight: 1.65 }}>
          {state.status === 'loading'
            ? 'Do not close this tab while the sign-in is completing. This browser will stay signed in until you log out from the admin CRM.'
